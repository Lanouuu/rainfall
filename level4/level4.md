...
Dump of assembler code for function n:
   ...
   0x08048465 <+14>:	mov    DWORD PTR [esp+0x8],eax      # 3eme arg fgets (stdin)
   0x08048469 <+18>:	mov    DWORD PTR [esp+0x4],0x200    # 2eme arg fgets (512)
   ...
   0x08048492 <+59>:	cmp    eax,0x1025544                # if m == 16930116 (en decimal)
...
Cette variable globale s'identifie grace au préfixe `ds:` qui désigne une adresse absolue et fixe, indépendante de `ebp`, elle n'est pas stockée sur la pile.
