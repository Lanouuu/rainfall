``` bash
bonus2@RainFall:~$ ltrace ./bonus2 AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA AAAAAAAAAAAAAAAAAAAAAAAAAA
__libc_start_main(0x8048529, 3, 0xbffff734, 0x8048640, 0x80486b0 <unfinished ...>
strncpy(0xbffff630, "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"..., 40) = 0xbffff630
strncpy(0xbffff658, "AAAAAAAAAAAAAAAAAAAAAAAAAA", 32)         = 0xbffff658
getenv("LANG")                                                = "en_US.UTF-8"
memcmp(0xbfffff17, 0x804873d, 2, 0xb7fff918, 0)               = -1
memcmp(0xbfffff17, 0x8048740, 2, 0xb7fff918, 0)               = -1
strcat("Hello ", "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA"...)       = "Hello AAAAAAAAAAAAAAAAAAAAAAAAAA"...
puts("Hello AAAAAAAAAAAAAAAAAAAAAAAAAA"...Hello AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA
)                   = 73
--- SIGSEGV (Segmentation fault) ---
+++ killed by SIGSEGV +++
bonus2@RainFall:~$ ltrace ./bonus2 en_US.UTF-8 en_US.UTF-8
__libc_start_main(0x8048529, 3, 0xbffff7d4, 0x8048640, 0x80486b0 <unfinished ...>
strncpy(0xbffff6d0, "en_US.UTF-8", 40)                        = 0xbffff6d0
strncpy(0xbffff6f8, "en_US.UTF-8", 32)                        = 0xbffff6f8
getenv("LANG")                                                = "en_US.UTF-8"
memcmp(0xbfffff17, 0x804873d, 2, 0xb7fff918, 0)               = -1
memcmp(0xbfffff17, 0x8048740, 2, 0xb7fff918, 0)               = -1
strcat("Hello ", "en_US.UTF-8")                               = "Hello en_US.UTF-8"
puts("Hello en_US.UTF-8"Hello en_US.UTF-8
)                                     = 18
+++ exited (status 18) +++
```

AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAABBBBBBBBBBBBBBBBBBBBBBBBBBBBBBB
limite 71

Alan a dit y a 40 entre les 2 
...
Dump of assembler code for function main:
   ...
   0x08048548 <+31>:	lea    ebx,[esp+0x50]                   # buffer1
   ...
   0x08048570 <+71>:	lea    eax,[esp+0x50]                   # buffer1
   ...
   0x08048590 <+103>:	lea    eax,[esp+0x50]                   # buffer1
   0x08048594 <+107>:	add    eax,0x28                         # buffer2
   ...
   0x080485bc <+147>:	mov    DWORD PTR [esp+0x8],0x2          # size =2
   0x080485c4 <+155>:	mov    DWORD PTR [esp+0x4],0x804873d    # "fi"
   0x080485cc <+163>:	mov    eax,DWORD PTR [esp+0x9c]         # retour getenv
   0x080485d3 <+170>:	mov    DWORD PTR [esp],eax              # 1er arg(fr..)
   0x080485d6 <+173>:	call   0x8048360 <memcmp@plt>           # memcmp(getenv, "fi", 2)
   0x080485db <+178>:	test   eax,eax
   0x080485dd <+180>:	jne    0x80485eb <main+194>
   0x080485df <+182>:	mov    DWORD PTR ds:0x8049988,0x1       # language
   0x080485e9 <+192>:	jmp    0x8048618 <main+239>
   0x080485eb <+194>:	mov    DWORD PTR [esp+0x8],0x2          # size = 2
   0x080485f3 <+202>:	mov    DWORD PTR [esp+0x4],0x8048740    # "nl"
   0x080485fb <+210>:	mov    eax,DWORD PTR [esp+0x9c]         # retour getenv
   0x08048602 <+217>:	mov    DWORD PTR [esp],eax              # 1er arg
   0x08048605 <+220>:	call   0x8048360 <memcmp@plt>           # memcmp(getenv, "nl", 2)
   0x0804860a <+225>:	test   eax,eax
   0x0804860c <+227>:	jne    0x8048618 <main+239>
   0x0804860e <+229>:	mov    DWORD PTR ds:0x8049988,0x2        # language
   0x08048618 <+239>:	mov    edx,esp                          # retour getenv 0xbfffff29 "en_US.UTF-8"
   0x0804861a <+241>:	lea    ebx,[esp+0x50]                   # buffer1 
   0x0804861e <+245>:	mov    eax,0x13                         
   0x08048623 <+250>:	mov    edi,edx                          # 0xbfffff29 "en_US.UTF-8"
...
Dump of assembler code for function greetuser:
   ...
   0x0804848a <+6>:	    mov    eax,ds:0x8049988             # langage
   0x0804848f <+11>:	cmp    eax,0x1                      # "fi"
   0x08048492 <+14>:	je     0x80484ba <greetuser+54>
   0x08048494 <+16>:	cmp    eax,0x2                      # "nl"
   0x08048497 <+19>:	je     0x80484e9 <greetuser+101>
   0x08048499 <+21>:	test   eax,eax                      # null ?
   ...
   0x080484ba <+54>:	mov    edx,0x8048717                # choix "fi" "Hyvää päivää "
   ...
   0x080484e9 <+101>:	mov    edx,0x804872a               # choix "nl" "Goedemiddag! "
