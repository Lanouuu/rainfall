...
Dump of assembler code for function main:
   ...
   0x08048574 <+16>:	nop
   0x08048575 <+17>:	mov    ecx,DWORD PTR ds:0x8049ab0   # service "" charge la valeur stoke
   0x0804857b <+23>:	mov    edx,DWORD PTR ds:0x8049aac   # globale auth ""
   ...
   0x0804859f <+59>:	mov    DWORD PTR [esp+0x4],0x80 # 2eme arg fgets taille
   0x080485a7 <+67>:	lea    eax,[esp+0x20]           # on recup ladresse du buffer
   0x080485ab <+71>:	mov    DWORD PTR [esp],eax      # 1er arg de fgets
   0x080485ae <+74>:	call   0x8048440 <fgets@plt>    # fgets(buffer, 0x80, stdin)
   0x080485b3 <+79>:	test   eax,eax                  # === input (ET BINAIRE)
   0x080485b5 <+81>:	je     0x804872c <main+456>     # break
   0x080485bb <+87>:	lea    eax,[esp+0x20]           # buffer
   0x080485bf <+91>:	mov    edx,eax                  # buffer dans edx
   ...
   0x080485d9 <+117>:	sub    cl,al                    # cl == 4 (decr de i)
   0x080485db <+119>:	mov    eax,ecx
   0x080485dd <+121>:	movsx  eax,al
   0x080485e0 <+124>:	test   eax,eax
   0x080485e2 <+126>:	jne    0x8048642 <main+222>     # "auth " -> evite le jmp
   ...
   0x08048600 <+156>:	lea    eax,[esp+0x20]           # buffer
   0x08048604 <+160>:	add    eax,0x5                  # + 5 sur l'addr du buffer
   ...
   0x0804863d <+217>:	call   0x8048460 <strcpy@plt>           # ALLER ICI
   ...
   0x0804871f <+443>:	mov    DWORD PTR [esp],eax          # 1er arg de write "Password:\n"
